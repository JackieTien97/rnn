...
if __name__ == '__main__':
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        if valid_loss < best_valid_pp:
            ...
            best_model = MyModel
            torch.save(best_model, os.path.join(save_directory, 'best_model_layer2_bptt128_em256.pt'))
    ...
    plt.legend()
    plt.savefig('Accuracy_pp_layer2_bptt128_em256_without_clip.jpg')
    ...
    plt.xticks(np.arange(1, num_epochs + 1, 20.0))
    plt.legend()
    plt.savefig('Loss_pp_layer2_bptt128_em256_without_clip.jpg')
